...
public class ListDropDownAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.layout_wish_list_dropdown_item, null);
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.themeRed));
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
            super();
            mText = (TextView) view.findViewById(R.id.wish_list_dropdown_text);
        }
    }
}